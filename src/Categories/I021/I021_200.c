...
void set_I021_200_ICF(I021_200 * item, const uint8_t icf) {
    // TODO: Check valus is within range
    SET_BITS(&(item->raw), icf, MASK_01_BITS, 8);
}

void set_I021_200_LNAV(I021_200 * item, const uint8_t lnav) {
    // TODO: Check valus is within range
    SET_BITS(&(item->raw), lnav, MASK_01_BITS, 7);
}

void set_I021_200_ME(I021_200 * item, const uint8_t me) {
    // TODO: Check valus is within range
    SET_BITS(&(item->raw), me, MASK_01_BITS, 6);
}

void set_I021_200_PS(I021_200 * item, const uint8_t ps) {
    // TODO: Check valus is within range
    SET_BITS(&(item->raw), ps, MASK_03_BITS, 3);
}

void set_I021_200_SS(I021_200 * item, const uint8_t ss) {
    // TODO: Check valus is within range
