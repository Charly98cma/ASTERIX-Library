...
double get_I021_072_TAV_seconds(const I021_072 * item) {
    return (double) get_I021_072_TAV_raw(item) * I021_072_LSB_TAV;
}
...
void set_I021_072_TAV_raw(I021_072 * item, const uint32_t raw_value) {
...
void set_I021_072_TAV_seconds(I021_072 * item, const double seconds) {
    ...
    if (seconds <= 0)
        raw_value = (uint32_t) ((seconds / I021_072_LSB_TAV) + 0.5);

    set_I021_072_TAV_raw(item, raw_value);
}
