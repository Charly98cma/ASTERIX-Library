...
{
    return (get_cat021_item077_TART_raw(item) * CAT021_ITEM077_LSB_TART);
}
...
void set_cat021_item077_TART_raw(cat021_item077 * item, const uint32_t raw_value)
{
...
void set_cat021_item077_TART_seconds(cat021_item077 * item, const double seconds)
{
    ...
    if (seconds > 0)
        raw_value = (uint32_t) ((seconds / CAT021_ITEM077_LSB_TART) + 0.5);
