 ...
 ******************************************************************************/
 ...
 /**
 * @brief Get Time of Message Reception for Position raw value from Cat 021 Item 073.
 *
...
{
    return get_cat021_item073_TMRP_raw(item) * LSB_CAT021_ITEM073;
}
 ...
 ******************************************************************************/
 ...
 /**
 * @brief Set the Time of Message Reception for Position raw value into Cat 021 Item 073.
 *
 ...
 */
void set_cat021_item073_TMRP_seconds(cat021_item073 * item, double seconds)
{
...
/**
 * @brief Print the contents of CAT021 Item 073 (Time of Message Reception for Position).
 * 
 * Prints both the raw value and the converted time in seconds.
 * 
 * @param item Pointer to cat021_item073_t structure.
 */
