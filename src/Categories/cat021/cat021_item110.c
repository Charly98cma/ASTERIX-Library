                                     ...
                                     const uint8_t index)
{
    ...
    return alt_raw * CAT021_ITEM110_LSB_ALT; 
}
                                   ...
                                   const uint8_t index)
{
    ...
    return lat_raw * CAT021_ITEM110_LSB_LAT;
}
                                   ...
                                   const uint8_t index)
{
    ...
    return lon_raw * CAT021_ITEM110_LSB_LON;
}
                                     ...
                                     const uint8_t index)
{
    ...
    return tov_raw * CAT021_ITEM110_LSB_TOV;
}
                                   ...
                                   const uint8_t index)
{
    ...
    return ttr_raw * CAT021_ITEM110_LSB_TTR;
}
...
void set_cat021_item110_ext2_ALT(cat021_item110_ext2 * item, const uint8_t index, double value)
{
    ...
    alt_raw = value / CAT021_ITEM110_LSB_ALT;
...
void set_cat021_item110_ext2_LAT(cat021_item110_ext2 * item, const uint8_t index, uint32_t value)
{
    ...
    lat_raw = value / CAT021_ITEM110_LSB_LAT;
...
void set_cat021_item110_ext2_LON(cat021_item110_ext2 * item, const uint8_t index, uint32_t value)
{
    ...
    lon_raw = value / CAT021_ITEM110_LSB_LON;
...
void set_cat021_item110_ext2_TTR(cat021_item110_ext2 * item, const uint8_t index, double value)
{
    ...
    ttr_raw = value / CAT021_ITEM110_LSB_TTR;
