...
void set_cat021_item210_VNS(cat021_item210 * item, const uint8_t vns)
{
    SET_BITS(&(item->raw), vns, MASK_01_BITS, 7);
}

void set_cat021_item210_VN(cat021_item210 * item, const uint8_t vn)
{
    SET_BITS(&(item->raw), vn, MASK_03_BITS, 4);
}

void set_cat021_item210_LTT(cat021_item210 * item, const uint8_t ltt)
{
