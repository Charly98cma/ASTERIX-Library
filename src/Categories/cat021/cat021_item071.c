...
#include "Categories/cat021/cat021_item071.h"
...
{
    return get_cat021_item071_TAP_raw(item) * CAT021_ITEM071_LSB_TAP;
}
...
void set_cat021_item071_TAP_raw(cat021_item071 * item, const uint32_t raw_value)
{
...
void set_cat021_item071_TAP_seconds(cat021_item071 * item, const double seconds)
{
    ...
    if (seconds > 0)
        raw_value = (uint32_t) ((seconds / CAT021_ITEM071_LSB_TAP) + 0.5);
