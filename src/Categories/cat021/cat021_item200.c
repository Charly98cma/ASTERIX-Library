...
void set_cat021_item200_ICF(cat021_item200 * item, const uint8_t icf)
{
    // TODO: Check valus is within range
    SET_BITS(&(item->raw), icf, MASK_01_BITS, 8);
}

void set_cat021_item200_LNAV(cat021_item200 * item, const uint8_t lnav)
{
    // TODO: Check valus is within range
    SET_BITS(&(item->raw), lnav, MASK_01_BITS, 7);
}

void set_cat021_item200_ME(cat021_item200 * item, const uint8_t me)
{
    // TODO: Check valus is within range
    SET_BITS(&(item->raw), me, MASK_01_BITS, 6);
}

void set_cat021_item200_PS(cat021_item200 * item, const uint8_t ps)
{
    // TODO: Check valus is within range
    SET_BITS(&(item->raw), ps, MASK_03_BITS, 3);
}

void set_cat021_item200_SS(cat021_item200 * item, const uint8_t ss)
{
    // TODO: Check valus is within range
