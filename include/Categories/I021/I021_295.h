...
/** @brief Encode item I021/295 (Data Ages) into a raw ASTERIX message.
 *
 * @param item_in Pointer to the input I021/295 structure.
...
/** @brief Decode item I021/295 (Data Ages) from a raw ASTERIX message.
 *
 * @param item_out Pointer to the output I021/295 structure to populate.
