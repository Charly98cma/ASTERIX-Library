...
#define I021_220_EXT1_MIN_TURB        0
/// @brief Minimum value of Turbulance
#define I021_220_EXT1_MAX_TURB        15
...
/**
 * @brief Get Wind Direction (WINDDIR) subfield presence from I021/220
 *        Primary Subfield
 * 
 * @param item pointer to I021_220 structure
 * 
...
/**
 * @brief Get Turbulance (TURB) subfield presence from I021/220
 *        Primary Subfield
 * 
 * @param item pointer to I021_220 structure
 * 
 ...
 */
ASTERIX_API uint16_t get_I021_220_EXT1_WINDSPD(const I021_220_EXT1 * item);
 ...
 */
ASTERIX_API uint16_t get_I021_220_EXT2_WINDDIR(const I021_220_EXT2 * item);
 ...
 */
ASTERIX_API uint8_t get_I021_220_EXT4_TURB(const I021_220_EXT4 * item);
...
/**
 * @brief Set Wind Speed (WINDSPD) subfield presence into I021/220
 *        Primary Subfield
 * 
 * @param item pointer to I021_220 structure
 * @param ws value of new Wind Speed subfield presence indicator
 */
ASTERIX_API void set_I021_220_WS(I021_220 * item, const uint8_t ws);

/**
 * @brief Set Wind Direction (WINDDIR) subfield presence into I021/220
 *        Primary Subfield
 * 
 * @param item pointer to I021_220 structure
 * @param wd value of new Wind Direction subfield presence indicator
 */
ASTERIX_API void set_I021_220_WD(I021_220 * item, const uint8_t wd);
 ...
 */
ASTERIX_API void set_I021_220_TEMP(I021_220 * item, const uint8_t temp);

/**
 * @brief Set Turbulance (TURB) subfield presence into I021/220
 *        Primary Subfield
 * 
 * @param item pointer to I021_220 structure
 * @param trb value of new Turbulance subfield presence indicator
 */
ASTERIX_API void set_I021_220_TRB(I021_220 * item, const uint8_t trb);
 ...
 *                                            1: extension present)
 */
ASTERIX_API void set_I021_220_FX(I021_220 * item, const uint8_t fx);
 ...
 */
ASTERIX_API void set_I021_220_EXT1_WINDSPD(I021_220_EXT1 * item, const uint16_t wind_spd);
 ...
 */
ASTERIX_API void set_I021_220_EXT2_WINDDIR(I021_220_EXT2 * item, const uint16_t wind_dir);
 ...
 */
ASTERIX_API void set_I021_220_EXT3_TEMP(I021_220_EXT3 * item, const double temp);
 ...
 */
ASTERIX_API void set_I021_220_EXT4_TURB(I021_220_EXT4 * item, const uint8_t turb);
