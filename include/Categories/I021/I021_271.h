...
/** @brief Encode item I021/271 (Surface Capabilities and Characteristics) into a raw ASTERIX message.
 *
 * @param item_in Pointer to the input I021/271 structure.
...
/** @brief Decode item I021/271 (Surface Capabilities and Characteristics) from a raw ASTERIX message.
 *
 * @param item_out Pointer to the output I021/271 structure to populate.
