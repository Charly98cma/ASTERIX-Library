...
/** @brief Encode item I021/020 (Emitter Category) into a raw ASTERIX message.
 *
 * @param item_in Pointer to the input I021/020 structure.
...
/** @brief Decode item I021/020 (Emitter Category) from a raw ASTERIX message.
 *
 * @param item_out Pointer to the output I021/020 structure to populate.
