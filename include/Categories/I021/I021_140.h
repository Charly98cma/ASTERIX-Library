...
/** @brief Encode item I021/140 (Geometric Height) into a raw ASTERIX message.
 *
 * @param item_in Pointer to the input I021/140 structure.
...
/** @brief Decode item I021/140 (Geometric Height) from a raw ASTERIX message.
 *
 * @param item_out Pointer to the output I021/140 structure to populate.
