...
/** @brief Encode item I021/008 (Aircraft Operational Status) into a raw ASTERIX message.
 *
...
/** @brief Decode item I021/008 (Aircraft Operational Status) from a raw ASTERIX message.
 *
