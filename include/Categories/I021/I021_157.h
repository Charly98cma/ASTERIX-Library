...
/** @brief Encode item I021/157 (Geometric Vertical Rate) into a raw ASTERIX message.
 *
 * @param item_in Pointer to the input I021/157 structure.
...
/** @brief Decode item I021/157 (Geometric Vertical Rate) from a raw ASTERIX message.
 *
 * @param item_out Pointer to the output I021/157 structure to populate.
