...
/** @brief Encode item I021/250 (BDS Registry Data) into a raw ASTERIX message.
 *
 * @param item_in Pointer to the input I021/250 structure.
...
/** @brief Decode item I021/250 (BDS Registry Data) from a raw ASTERIX message.
 *
 * @param item_out Pointer to the output I021/250 structure to populate.
