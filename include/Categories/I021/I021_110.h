...
/** @brief Encode item I021/110 (???) into a raw ASTERIX message.
 *
 * @param item_in Pointer to the input I021/110 structure.
...
/** @brief Decode item I021/110 (???) from a raw ASTERIX message.
 *
 * @param item_out Pointer to the output I021/110 structure to populate.
