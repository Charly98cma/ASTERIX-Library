...
/** @brief Encode item I021/016 (Service Management) into a raw ASTERIX message.
 *
 * @param item_in Pointer to the input I021/016 structure.
...
/** @brief Decode item I021/016 (Service Management) from a raw ASTERIX message.
 *
 * @param item_out Pointer to the output I021/016 structure to populate.
