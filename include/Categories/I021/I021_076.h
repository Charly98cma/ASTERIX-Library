...
/** @brief Encode item I021/076 (time of Message Reception of Position-High Precision) into a raw ASTERIX message.
 *
 * @param item_in Pointer to the input I021/076 structure.
...
/** @brief Decode item I021/076 (time of Message Reception of Position-High Precision) from a raw ASTERIX message.
 *
 * @param item_out Pointer to the output I021/076 structure to populate.
